  ...
  <body>
    ...
    <div class="d-flex align-items-stretch">
      ...
      <div class="page-content">
        ...
        <form action="{{url('owner/update_costume', $data->id)}}" method="POST" enctype="multipart/form-data" class="my-5 mx-5 col-lg-8 col-sm-12">
          <h1 class="mb-4">Edit Kostum</h1>
          @csrf
          <div class="mb-3">
          ...
          <div class="row mb-3 d-flex align-items-end justify-content-center">
            ...
            <div class="col-5">
              ...
              <input type="number" class="form-control" id="day" name="day" value="{{$data->day}}" required>
            </div>
          </div>
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="size" name="size" required placeholder="format: S,L,XL / L,XL" value="{{$data->size}}">
          </div>
          <div class="mb-3 d-flex flex-column">
            <label for="available" class="form-label">Ketersediaan</label>
            <select class="form-select" aria-label="available" name="available" required style="height: 40px;" value="{{$data->available}}">
          ...
          <div class="mb-5">
            <div class="d-flex align-items-end">
              ...
              <img src="/costumes/{{$data->image}}" class="costume-img" alt="Costume">
            </div>
            <input class="form-control" type="file" id="image" name="image" value="{{$data->image}}">
          </div>
          <div class="mb-3">
            <input class="btn btn-success" type="submit" value="Update Kostum">
          </div>
        </form>
